...
class AnalyzerTest(Context):
	...
	def test_get_respa_kw_analysis_of_paorg_pres_decree_txts_1(self):
			...
			def analyze_issue(issue_articles):
				analysis_data_sums = {
			...
			analysis_data_sums_txt_1 = analyze_issue(articles_1)
			analysis_data_sums_txt_2 = analyze_issue(articles_2)
			analysis_data_sums_txt_3 = analyze_issue(articles_3)
			analysis_data_sums_txt_4 = analyze_issue(articles_4)
			analysis_data_sums_txt_5 = analyze_issue(articles_5)
	...
	def test_respa_kw_analysis_of_paorg_pres_decree_articles_1(self):
		...
		def print_n_gram_analysis(articles):
		...
		print("Bi-gram & Quad-gram data vectors")
		...
		print_n_gram_analysis(articles_1)
		print_n_gram_analysis(articles_2)
		print_n_gram_analysis(articles_3)
		print_n_gram_analysis(articles_4)
		print_n_gram_analysis(articles_5)
