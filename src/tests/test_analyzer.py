...
class AnalyzerTest(Context):
	...
	def test_issue_respa_clf_cross_validation(self):
		print("Issue clf")
		issue_clf = self.analyzer.IssueOrArticleRespAClassifier(self.issue_clf_data_csv)
		print("Simple cross-validation:")
		issue_clf.cross_validate(test_size=0.4)
		print("KFold cross-validation:")
		issue_clf.KFold_cross_validate()
		
	def test_article_respa_clf_cross_validation(self):
		print("Issue clf")
		article_clf = self.analyzer.IssueOrArticleRespAClassifier(self.artcl_clf_data_csv)
		print("Simple cross-validation:")
		article_clf.cross_validate(test_size=0.4)
		print("KFold cross-validation:")
		article_clf.KFold_cross_validate()
	...
	def test_respa_classifiers(self):
		...
		print(issue_clf.has_respas(txt_1_data_vec))
		print(issue_clf.has_respas(txt_2_data_vec))
		print(issue_clf.has_respas(txt_3_data_vec))
		...
		for artcl_data_vec in articles_1_data_vecs:
			print(article_clf.has_respas(artcl_data_vec))
		...
		print(issue_clf.has_respas(txt_2_data_vec))
		print(issue_clf.has_respas(txt_3_data_vec))
		print(issue_clf.has_respas(txt_4_data_vec))
		print(issue_clf.has_respas(txt_5_data_vec))
		print(issue_clf.has_respas(txt_6_data_vec))
