...
class ParserTest(unittest.TestCase):
	...
	def test_get_respas_of_organization_units_from_pres_decree_txts_1(self):
		...
		# rough_paorg_respa_sections_in_articles_1 = [self.parser.get_rough_respas_of_organization_units_from_pres_decree_txt(article)
		# 											for article in articles_1]
		# rough_paorg_respa_sections_in_articles_1 = list(filter(None, rough_paorg_respa_sections_in_articles_1))

		# rough_paorg_respa_sections_1 = [rough_paorg_respa_section 
		# 								for rough_paorg_respa_sections_per_article in rough_paorg_respa_sections_in_articles_1
		# 								for rough_paorg_respa_section in rough_paorg_respa_sections_per_article]
		# print(rough_paorg_respa_sections_1)
		

		# rough_paorg_respa_sections_in_articles_2 = [self.parser.get_rough_respas_of_organization_units_from_pres_decree_txt(article)
		# 											for article in articles_2]
		# rough_paorg_respa_sections_in_articles_2 = list(filter(None, rough_paorg_respa_sections_in_articles_2))

		# rough_paorg_respa_sections_2 = [rough_paorg_respa_section 
		# 								for rough_paorg_respa_sections_per_article in rough_paorg_respa_sections_in_articles_2
		# 								for rough_paorg_respa_section in rough_paorg_respa_sections_per_article]
		# print(rough_paorg_respa_sections_2)
	...
	def test_n_gram_analysis_on_respa_of_organization_units_occurrences_from_pres_decree_txts_1(self):
		...
		artcl_1_respa_occurs = 0
		for artcl in articles_1:
			respa_occurences_in_artcl = self.parser.get_respa_occurences_in_paorg_pres_decree_txt(artcl)
			artcl_1_respa_occurs += sum(respa_occurences_in_artcl['bigram_analysis'].values())
		print(artcl_1_respa_occurs)

		artcl_2_respa_occurs = 0
		for artcl in articles_2:
			respa_occurences_in_artcl = self.parser.get_respa_occurences_in_paorg_pres_decree_txt(artcl)
			artcl_2_respa_occurs += sum(respa_occurences_in_artcl['bigram_analysis'].values())
		print(artcl_2_respa_occurs)

		artcl_3_respa_occurs = 0
		for artcl in articles_3:
			respa_occurences_in_artcl = self.parser.get_respa_occurences_in_paorg_pres_decree_txt(artcl)
			artcl_3_respa_occurs += sum(respa_occurences_in_artcl['bigram_analysis'].values())
		print(artcl_3_respa_occurs)

		artcl_4_respa_occurs = 0
		for artcl in articles_4:
			respa_occurences_in_artcl = self.parser.get_respa_occurences_in_paorg_pres_decree_txt(artcl)
			artcl_4_respa_occurs += sum(respa_occurences_in_artcl['bigram_analysis'].values())
		print(artcl_4_respa_occurs)

		artcl_5_respa_occurs = 0
		for artcl in articles_5:
			respa_occurences_in_artcl = self.parser.get_respa_occurences_in_paorg_pres_decree_txt(artcl)
			artcl_5_respa_occurs += sum(respa_occurences_in_artcl['bigram_analysis'].values())
		print(artcl_5_respa_occurs)
